...
namespace Mood.Ammo
{
    [CreateAssetMenu(fileName = "AmmoDropTable", menuName = "MOOD/Ammo/Ammo Drop Table")]
    public sealed class AmmoDropTable : ScriptableObject
    {
        [Serializable]
        ...
        public int RollDrops(List<AmmoPickupData> results)
        {
            if (results == null)
            {
